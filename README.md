...
All eleven former skyline blocks are now part of the playable residential ring. Each 6- to 13-story tower has a tall standing-height street entrance, lit corridors with carpet runners, furnished apartments (sofa, bed, kitchenette, desk, wardrobe, room purpose signs), split floor slabs with clear stair wells, two shallow stair flights per story (visual treads over climbable ramps), and a walkable rooftop exit. Courtyards add sidewalks, raised entry canopies, planters, benches, and signed building entrances. Thirty-nine non-combatants occupy ground and upper floors: residents, evacuees, medical volunteers, community guards, and utility workers wander within their rooms and shelter when hostiles approach. Parked service trucks and court vehicles around the ring can be entered with `F`, driven with WASD, and used to ram hostiles; the distant tilt-rotor can be shot down.
