...
- `csharp/FreightTerminalWorld.Boss.cs`, `EnemyOperator.Boss.cs`, and `CombatHUD.Boss.cs`: roaming TIDE HUNTER behavior, phases, pulse attack, rewards, tracking HUD, and Boss diagnostics.
