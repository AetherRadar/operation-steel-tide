...
- Runtime output: `bazaar_crossing/bazaar_crossing.glb`, 107,169,064 bytes,
  SHA-256
...
- Editable packed source:
  `../../source_art/world/bazaar_crossing/bazaar_crossing.blend`, 49,534,466
  bytes, SHA-256
...
The final V2 scene contains 700 exported visible mesh nodes, 648 unique meshes,
935 material surfaces, 48 DCC materials, 58 DCC textures, 805,155 unique
triangles, and 1,101,693 delivered instance triangles. The textures are capped
at 1024 pixels and have an estimated 203.473 MiB RGBA8 plus full-mip-chain
cost. Static consolidation reduced 1,443 draw nodes to 700 and 1,950 surfaces
to 935 without changing either triangle count. The GLB is exported without
`KHR_draco_mesh_compression`; `EXT_texture_webp` is its only required
extension. Its round trip retains all 700 visible meshes, all 28 independently
auditable runtime-door portals, and the exact instance-triangle count while
checking scene bounds, four complete enterable interiors, three deck heights,
all six 3.2-meter stairs, UV/material coverage, explicit CC0 provenance, and
absence of false terminus/niche portals, Hero Mountain, Coast Line, all CC BY,
...
| --- | --- | --- | --- |
| NASA/Ames Research Center, **70 Meter Dish** | [NASA 3D resource](https://science.nasa.gov/3d-resources/70-meter-dish/); redistributable under the NASA Images and Media Usage Guidelines for factual-source-acknowledged, non-endorsement use (not MIT or CC0) | Raw source acquired 2026-09-01; SHA-256 `36FF56A7A2BFD1C278F6F4774D32128D5931F2C22FE58241D00EE7D1815634BB` | `../../source_art/third_party/nasa_3d/nasa_70_meter_dish.glb` -> `TelemetryDishStaticBase_*` and `TelemetryDishMovingAssembly_*` below `DishYaw` -> `DishPitch`; scaled, de-branded, weathered, and suspended as the reactor-hall telemetry landmark |
| NASA, **Orion Capsule (no fbc)** | [NASA 3D resource](https://science.nasa.gov/3d-resources/orion-capsule/); redistributable under the same NASA media guidelines and non-endorsement conditions (not MIT or CC0) | Raw source acquired 2026-09-01; SHA-256 `ABC4C69C27AFA55C4A06BC9972B8872979F1473FB26E15224FB0F77F1CD81DC7` | `../../source_art/third_party/nasa_3d/nasa_orion_capsule_no_fbc.stl` -> `RecoveredCapsule_Fictional` in `District_LaunchSilo`; scaled, recolored, scorched, and impact-posed as an unnamed fictional recovered article |
