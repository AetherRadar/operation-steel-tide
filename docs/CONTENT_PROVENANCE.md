...
| Factory Kit 3.0 modular interior GLB set | Kenney | CC0 1.0 | Acquired 2026-08-19 from `https://kenney.nl/assets/factory-kit`; local mapping and license copy in `assets/models/kenney_factory_kit/` |
