...
| Factory Kit 3.0 authored overhead and personnel doors | Kenney; personnel-door sample scene cleaned and hinge pivot prepared in Blender for this project | CC0 1.0 | Official pack from `https://kenney.nl/assets/factory-kit`; overhead door acquired 2026-08-19, personnel door acquired and adapted 2026-08-27; local source, runtime derivatives, extracted colormap, and license copy in `assets/models/kenney_factory_kit/` |
