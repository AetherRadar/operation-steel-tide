...
public sealed partial class DemolitionArenaLayout
{
    ...
    private IReadOnlyList<DemolitionArenaBox> BuildHarborLocksCollisionBoxes()
    {
        return new[]
        {
            ...
            // Invisible blockers sit inside matching authored buildings and remove direct
            // spawn-to-site vision without adding programmer-art structures.
            Box("SightBlockWestTurbine", new(-42.3f, 2.5f, -3.0f), new(13.7f, 5.0f, 15.3f), "steel_dark", visible: false),
            Box("SightBlockSouthAnnex", new(-8.0f, 2.5f, 33.0f), new(17.5f, 5.0f, 9.0f), "steel_dark", visible: false),
    ...
    private IReadOnlyList<DemolitionArenaBox> BuildHarborLocksDetailBoxes()
    {
        var boxes = new List<DemolitionArenaBox>
        {
            ...
            Box("WestControlYard", new(-41.0f, 0.09f, -20.0f), new(15.0f, 0.1f, 13.0f), "harbor_floor"),
            Box("EastPumpYard", new(41.0f, 0.09f, 20.0f), new(15.0f, 0.1f, 13.0f), "harbor_floor"),
    ...
    private IReadOnlyList<DemolitionArenaProp> BuildHarborLocksProps()
    {
        return new[]
        {
            ...
            HarborBuilding("WestTurbineHall", "building-c.glb", new(-43.0f, 0.02f, -4.0f), 0.0f, 7.2f, new(1.88f, 1.25f, 2.11f), new(0.096f, 0.625f, 0.143f)),
            HarborBuilding("NorthFreightHall", "building-q.glb", new(-16.0f, 0.02f, -32.0f), 0.0f, 7.2f, new(2.14f, 0.88f, 1.77f), new(-0.228f, 0.44f, 0.011f)),
            HarborBuilding("NorthAdministration", "building-h.glb", new(8.0f, 0.02f, -33.0f), Mathf.Pi, 7.0f, new(1.32f, 0.73f, 1.31f), new(-0.581f, 0.365f, 0.279f)),
            HarborBuilding("EastBoilerHall", "building-l.glb", new(43.0f, 0.02f, -14.0f), Mathf.Pi, 7.2f, new(2.08f, 1.92f, 1.87f), new(-0.422f, 0.96f, 0.224f)),
            HarborBuilding("EastPumpHall", "building-b.glb", new(42.0f, 0.02f, 33.0f), Mathf.Pi, 8.5f, new(2.08f, 1.47f, 1.26f)),
            HarborBuilding("SouthFreightHall", "building-e.glb", new(15.0f, 0.02f, 33.0f), 0.0f, 7.2f, new(1.68f, 1.65f, 1.29f), new(0.0f, 0.825f, 0.249f)),
            HarborBuilding("SouthControlAnnex", "building-r.glb", new(-8.0f, 0.02f, 33.0f), 0.0f, 7.0f, new(2.48f, 1.39f, 1.27f)),

            HarborBuilding("MidCoverWestOffice", "building-h.glb", new(-23.0f, 0.02f, -14.0f), 0.0f, 5.0f, new(1.32f, 0.73f, 1.31f), new(-0.581f, 0.365f, 0.279f)),
            HarborBuilding("MidCoverEastOffice", "building-t.glb", new(23.0f, 0.02f, 14.0f), Mathf.Pi * 0.5f, 5.0f, new(1.72f, 1.01f, 1.39f)),
            HarborBuilding("MidCoverNorthPump", "building-f.glb", new(-3.0f, 0.02f, -16.0f), 0.0f, 5.5f, new(1.79f, 1.93f, 1.28f), new(-0.453f, 0.965f, 0.254f)),
            HarborBuilding("MidCoverSouthPump", "building-n.glb", new(3.0f, 0.02f, 16.0f), Mathf.Pi, 5.5f, new(0.98f, 1.90f, 1.42f), new(-0.452f, 0.95f, 0.56f)),
            HarborBuilding("MidCoverTankNorthWest", "detail-tank.glb", new(-14.0f, 0.02f, -5.0f), 0.0f, 4.5f, new(0.85f, 0.42f, 0.52f)),
            HarborBuilding("MidCoverTankNorthEast", "detail-tank.glb", new(13.0f, 0.02f, -6.0f), Mathf.Pi * 0.5f, 4.5f, new(0.85f, 0.42f, 0.52f)),
