        ...
        try
        {
            ...
            var productionMapCoverage = demolitionLayouts
                ...
                .SequenceEqual(DemolitionMapCatalog.Maps
                    ...
                    .Select(map => map.Id)
                    .OrderBy(mapId => mapId, StringComparer.Ordinal));
            var retakeDistribution = DemolitionRetakeDistributionDiagnostics.Run(
                demolitionLayouts,
                _demolitionStrategyPlanner);
