...
public partial class FreightTerminalWorld
{
    private static class RuntimeDiagnosticRunner
    {
        private static readonly (string Argument, Action<FreightTerminalWorld> Run)[] Commands =
        {
            ...
            ("--validate-training-range", static world => world.ValidateTrainingRange()),
            ...
            ("--validate-orbital-map", static world => world.ValidateOrbitalMap()),
            ("--validate-orbital-collision", static world => world.ValidateOrbitalCollision()),
            ("--validate-orbital-gameplay", static world => world.ValidateOrbitalGameplay()),
            ("--validate-orbital-spawns", static world => world.ValidateOrbitalSpawns()),
            ("--validate-orbital-loading", static world => world.ValidateOrbitalLoading()),
            ("--validate-orbital-atmosphere", static world => world.ValidateOrbitalAtmosphere()),
            ("--validate-orbital-water", static world => world.ValidateOrbitalWater()),
            ("--validate-orbital-integration", static world => world.ValidateOrbitalComplexIntegration()),
            ...
            ("--capture-orbital-map", static world => world.CaptureOrbitalMap()),
            ("--capture-orbital-coast", static world => world.CaptureOrbitalCoast()),
