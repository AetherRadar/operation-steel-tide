...
public partial class FreightTerminalWorld
{
    private static class RuntimeDiagnosticRunner
    {
        private static readonly (string Argument, Action<FreightTerminalWorld> Run)[] Commands =
        {
            ...
            ("--validate-demolition-utility", static world => world.ValidateDemolitionUtility()),
            ("--validate-demolition-weapons", static world => world.ValidateDemolitionWeapons()),
            ("--validate-demolition-team-status", static world => world.ValidateDemolitionTeamStatus()),
            ...
            ("--capture-bazaar-crossing", static world => world.CaptureBazaarCrossing()),
            ...
            ("--capture-reload-frames-m4a1", static world => world.CaptureReloadFrameSequence(WeaponPlatform.M4A1)),
            ("--capture-reload-frames-ak74", static world => world.CaptureReloadFrameSequence(WeaponPlatform.AK74)),
            ("--capture-reload-frames-mp5a5", static world => world.CaptureReloadFrameSequence(WeaponPlatform.MP5A5)),
            ("--capture-reload-frames-gsh18", static world => world.CaptureReloadFrameSequence(WeaponPlatform.GSh18)),
            ("--capture-reload-keyframes-m4a1", static world => world.CaptureReloadPoseKeyframes(WeaponPlatform.M4A1)),
            ("--capture-reload-keyframes-ak74", static world => world.CaptureReloadPoseKeyframes(WeaponPlatform.AK74)),
            ("--capture-reload-keyframes-mp5a5", static world => world.CaptureReloadPoseKeyframes(WeaponPlatform.MP5A5)),
            ("--capture-reload-keyframes-gsh18", static world => world.CaptureReloadPoseKeyframes(WeaponPlatform.GSh18)),
            ...
            ("--validate-squad-sustainment", static world => world.ValidateSquadSustainment()),
            ...
            ("--validate-squad-door-rescue", static world => world.ValidateSquadDoorRescue()),
            ("--validate-squad-glass-rescue", static world => world.ValidateSquadGlassRescue()),
            ...
            ("--validate-extraction-survivors", static world => world.ValidateExtractionSurvivors()),
            ...
            ("--validate-ai-ladders", static world => world.ValidateAiLadders()),
            ...
            ("--validate-jianghai-interiors", static world => world.ValidateJianghaiInteriors()),
            ...
            ("--validate-reload-render-cadence", static world => world.ValidateReloadRenderCadence()),
            ("--validate-first-person-camera", static world => world.ValidateFirstPersonCameraInterpolation()),
