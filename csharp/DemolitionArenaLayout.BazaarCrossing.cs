...
public sealed partial class DemolitionArenaLayout
{
    ...
    private IReadOnlyList<DemolitionArenaBox> BuildBazaarCrossingCollisionBoxes()
    {
        var boxes = new List<DemolitionArenaBox>
        {
            ...
            BazaarCollisionBox("MassSouthWestLaneClosure", new(-46.0f, 4.2f, 39.25f), new(6.0f, 8.4f, 5.5f)),
            BazaarCollisionBox("MassSouthEastLaneClosure", new(46.0f, 4.2f, 39.25f), new(6.0f, 8.4f, 5.5f)),
