...
internal static class FirstPersonReloadProfileCatalog
{
    ...
    private static FirstPersonReloadProfile Sidearm(
        ...
        => new(
            ...
            SharedMagazineHome,
            SharedSpareHome,
            new Vector3(0.035f, -0.035f, 0.315f),
            new Vector3(-0.04f, -0.44f, -0.28f),
            new Vector3(-0.18f, -0.58f, -0.22f),
            new Vector3(-0.09f, -0.34f, -0.26f),
            new Vector3(-0.19f, 0.0f, 0.0f),
            new Vector3(0.38f, 0.04f, 0.22f),
            new Vector3(0.28f, 0.0f, 0.20f),
            SharedActionHome,
