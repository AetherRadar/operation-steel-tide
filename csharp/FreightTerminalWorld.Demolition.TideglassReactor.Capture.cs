...
public partial class FreightTerminalWorld
{
    private async void CaptureTideglassReactor()
    {
        ...
        var captures = new[]
        {
            ...
            (Path: "res://tideglass_reactor_north_guild.png", Position: new Vector3(-42.0f, playerEyeHeight, -30.0f), Target: new Vector3(-28.0f, 4.5f, -48.5f)),
            ...
            (Path: "res://tideglass_reactor_south_gatehouse.png", Position: new Vector3(-43.0f, playerEyeHeight, 25.0f), Target: new Vector3(-39.5f, 6.2f, 48.2f)),
            ...
            (Path: "res://tideglass_reactor_construction_turbine_workshop.png", Position: new Vector3(-45.0f, playerEyeHeight, 34.0f), Target: new Vector3(-31.0f, 3.2f, 16.0f)),
            (Path: "res://tideglass_reactor_reactor_annex.png", Position: new Vector3(25.0f, playerEyeHeight, -35.0f), Target: new Vector3(32.0f, 2.3f, -21.5f)),
            ...
            (Path: "res://tideglass_reactor_reactor_boiler_workshop.png", Position: new Vector3(5.0f, playerEyeHeight, -7.0f), Target: new Vector3(10.0f, 4.0f, -20.2f)),
            ...
            (Path: "res://tideglass_reactor_civic_utility_office.png", Position: new Vector3(-23.0f, playerEyeHeight, 26.0f), Target: new Vector3(-12.5f, 2.4f, 23.8f)),
            ...
            (Path: "res://tideglass_reactor_reactor_maintenance_depot.png", Position: new Vector3(60.0f, playerEyeHeight, -28.0f), Target: new Vector3(39.0f, 4.7f, -40.5f)),
            ...
            (Path: "res://tideglass_reactor_north_freight_office.png", Position: new Vector3(20.0f, playerEyeHeight, -17.0f), Target: new Vector3(20.0f, 2.5f, -31.5f)),
            ...
            (Path: "res://tideglass_reactor_southwest_watch_house.png", Position: new Vector3(-8.0f, playerEyeHeight, 39.0f), Target: new Vector3(-25.9f, 6.8f, 34.2f)),
            ...
            (Path: "res://tideglass_reactor_north_foundry_tenement.png", Position: new Vector3(-4.0f, playerEyeHeight, -16.0f), Target: new Vector3(-17.5f, 8.0f, -31.2f)),
