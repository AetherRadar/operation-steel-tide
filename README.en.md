...
- **A second competitive ruleset:** browse a twelve-map pool with Tideforge Arena, Harbor Locks, Tideglass Reactor, and Bazaar Crossing currently playable, then enter MR12 5v5 rounds with manual purchases, side swaps, overtime, planting, defusing, and role-aware tactical AI.
